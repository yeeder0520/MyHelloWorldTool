...
public class VanPartyExt extends DataObject implements Serializable {

    /**
	 * 
	 */
	private static final long serialVersionUID = 2565551821107437890L;
	public static final String TABLE_NAME ="VAN_PARTY_EXT";
    ...
    /**
     * set EXT_TYPE
     * @param extType - String
     */ 
    public void setExtType(String extType) {
        setValue(EXT_TYPE, extType);
    }

    /**
     * @return String - the EXT_TYPE field
     */ 
    public String getExtType() {
        return getString(EXT_TYPE);
    }
